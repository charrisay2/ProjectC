  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          <div className="card p-8 text-center">
            ...
            <p className="text-primary font-semibold text-sm mb-6">
              {user.studentId || user.teacherId || "Vai trò"}
            </p>
            ...
            {user.role === "STUDENT" && (
              <div className="pt-6 border-t border-slate-100 grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-bold text-slate-800">{user.gpa}</p>
                </div>
              </div>
            )}
          </div>
        ...
        {/* Right Column: Academic/Work Details */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs text-slate-400 font-bold uppercase mb-1">
                      {user.role === "STUDENT" ? "Ngành học" : "Chuyên môn"}
                    </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-600 font-bold">Đang hoạt động</p>
                  </div>
                </div>
              </div>
            </div>
