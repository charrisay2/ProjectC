  ...
  useEffect(() => {
    ...
    newSocket.on('notification', (newNotif: any) => {
      ...
      if (isForMe) {
        ...
        // Refresh data if it's a class update
    ...
    <div className="flex flex-col h-full py-6">
      <div className="px-6 mb-10 flex items-center gap-3">
        ...
        <div className={!isSidebarOpen ? 'hidden' : ''}>
          ...
          <p className="text-[10px] uppercase tracking-widest text-blue-200 font-bold">{user.role} System</p>
        </div>
      </div>
      ...
      <nav className="flex-1 px-3 space-y-1">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <Icon size={20} className={isActive ? 'text-primary' : 'text-blue-200 group-hover:text-white'} />
      ...
      <div className="px-3 mt-auto">
        ...
        >
          <LogOut size={20} className="text-blue-200 group-hover:text-red-200" />
          ...
          <div className="flex items-center gap-2 md:gap-4 relative">
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="text-xs font-bold text-slate-700 hidden lg:block">Chuyển vai trò</span>
              </button>
              ...
              <AnimatePresence>
                {isRoleSwitcherOpen && (
                  ...
                  >
                    <p className="text-[10px] font-bold text-slate-400 uppercase px-3 py-2">Chọn vai trò Demo</p>
                    {(['ADMIN', 'TEACHER', 'STUDENT'] as UserRole[]).map((role) => (
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                          user.role === role ? 'bg-primary text-white' : 'hover:bg-slate-100 text-slate-700'
                        }`}
                      >
                        {role}
                      </button>
